      ...
      <div className="z-10 sm:order-1 sm:col-span-2 mt-1">
        {project.image ? (
          <img
            ...
            alt={project.title}
            loading="lazy"
            className="rounded border-2 border-[#26282E] transition duration-300 ease-out group-hover:border-[#10B981] w-full aspect-[16/10] object-cover object-top"
          />
        ) : (
          <div className="rounded border-2 border-[#26282E] transition duration-300 ease-out group-hover:border-[#10B981] w-full aspect-[16/10] bg-[#17181C] flex items-center justify-center text-xs font-semibold text-[#9CA3AF]/60">
            No Image
          </div>
        )}
      </div>
        ...
        {project.live && project.github && (
          <div className="mt-3 flex items-center gap-1.5 relative z-30">
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="inline-flex items-center gap-1 text-xs font-semibold text-[#9CA3AF] hover:text-[#10B981] transition-colors duration-300 ease-out"
